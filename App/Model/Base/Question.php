...
abstract class Question implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Model\\Map\\QuestionTableMap';
    ...
    /**
     * Initializes internal state of App\Model\Base\Question object.
     * @see applyDefaults()
     */
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            if ($this->created === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[QuestionTableMap::COL_CREATED] = true;
            }
    ...
    public function setAuthorId($v)
    {
        ...
        if ($this->author_id !== $v) {
            $this->author_id = $v;
            $this->modifiedColumns[QuestionTableMap::COL_AUTHOR_ID] = true;
        }
    ...
    public function setTotalVotes($v)
    {
        ...
        if ($this->total_votes !== $v) {
            $this->total_votes = $v;
            $this->modifiedColumns[QuestionTableMap::COL_TOTAL_VOTES] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : QuestionTableMap::translateFieldName('Body', TableMap::TYPE_PHPNAME, $indexType)];
            $this->body = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : QuestionTableMap::translateFieldName('Created', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : QuestionTableMap::translateFieldName('AuthorId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(QuestionTableMap::COL_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'created';
        }
        if ($this->isColumnModified(QuestionTableMap::COL_AUTHOR_ID)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Model\Question The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(QuestionTableMap::COL_CREATED)) {
            $criteria->add(QuestionTableMap::COL_CREATED, $this->created);
        }
        if ($this->isColumnModified(QuestionTableMap::COL_AUTHOR_ID)) {
            $criteria->add(QuestionTableMap::COL_AUTHOR_ID, $this->author_id);
        }
        if ($this->isColumnModified(QuestionTableMap::COL_TOTAL_VOTES)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Model\Question (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Model\Question Clone of current object.
     * @throws PropelException
     */
    ...
    public function getAuthor(ConnectionInterface $con = null)
    {
        if ($this->aAuthor === null && (($this->author_id !== "" && $this->author_id !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAuthor->addQuestions($this);
             */
        }
     ...
     * @return ObjectCollection|ChildAnswer[] List of ChildAnswer objects
     */
    public function getAnswersJoinImage(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildAnswerQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aAuthor) {
            $this->aAuthor->removeQuestion($this);
        }
        $this->id = null;
        $this->body = null;
        $this->created = null;
