...
abstract class Vote implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Model\\Map\\VoteTableMap';
    ...
    /**
     * Initializes internal state of App\Model\Base\Vote object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\App\Model\Vote The current object (for fluent API support)
     */
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            if ($this->created === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[VoteTableMap::COL_CREATED] = true;
            }
    ...
    public function setAnswerId($v)
    {
        ...
        if ($this->answer_id !== $v) {
            $this->answer_id = $v;
            $this->modifiedColumns[VoteTableMap::COL_ANSWER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : VoteTableMap::translateFieldName('Created', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : VoteTableMap::translateFieldName('AnswerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->answer_id = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Model\\Vote'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(VoteTableMap::COL_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'created';
        }
        if ($this->isColumnModified(VoteTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(VoteTableMap::COL_ANSWER_ID)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aAnswer) {
                ...
                $result[$key] = $this->aAnswer->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Model\Vote The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VoteTableMap::COL_CREATED)) {
            $criteria->add(VoteTableMap::COL_CREATED, $this->created);
        }
        if ($this->isColumnModified(VoteTableMap::COL_USER_ID)) {
            $criteria->add(VoteTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(VoteTableMap::COL_ANSWER_ID)) {
            $criteria->add(VoteTableMap::COL_ANSWER_ID, $this->answer_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Model\Vote (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Model\Vote Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildAnswer object.
     *
     * @param  ChildAnswer $v
     * @return $this|\App\Model\Vote The current object (for fluent API support)
     * @throws PropelException
     */
    public function setAnswer(ChildAnswer $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildAnswer object, it will not be re-added.
        if ($v !== null) {
            $v->addVote($this);
        }
    ...
    /**
     * Get the associated ChildAnswer object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildAnswer The associated ChildAnswer object.
     * @throws PropelException
     */
    public function getAnswer(ConnectionInterface $con = null)
    {
        if ($this->aAnswer === null && ($this->answer_id !== null)) {
            $this->aAnswer = ChildAnswerQuery::create()->findPk($this->answer_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAnswer->addVotes($this);
             */
        }
