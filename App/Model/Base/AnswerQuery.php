 ...
 *
 * @method     ChildAnswerQuery leftJoinImage($relationAlias = null) Adds a LEFT JOIN clause to the query using the Image relation
 * @method     ChildAnswerQuery rightJoinImage($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Image relation
 * @method     ChildAnswerQuery innerJoinImage($relationAlias = null) Adds a INNER JOIN clause to the query using the Image relation
 *
 * @method     ChildAnswerQuery joinWithImage($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Image relation
 *
 * @method     ChildAnswerQuery leftJoinWithImage() Adds a LEFT JOIN clause and with to the query using the Image relation
 * @method     ChildAnswerQuery rightJoinWithImage() Adds a RIGHT JOIN clause and with to the query using the Image relation
 * @method     ChildAnswerQuery innerJoinWithImage() Adds a INNER JOIN clause and with to the query using the Image relation
 *
 * @method     ChildAnswerQuery leftJoinVote($relationAlias = null) Adds a LEFT JOIN clause to the query using the Vote relation
 * @method     ChildAnswerQuery rightJoinVote($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Vote relation
 * @method     ChildAnswerQuery innerJoinVote($relationAlias = null) Adds a INNER JOIN clause to the query using the Vote relation
 *
 * @method     ChildAnswerQuery joinWithVote($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Vote relation
 *
 * @method     ChildAnswerQuery leftJoinWithVote() Adds a LEFT JOIN clause and with to the query using the Vote relation
 * @method     ChildAnswerQuery rightJoinWithVote() Adds a RIGHT JOIN clause and with to the query using the Vote relation
 * @method     ChildAnswerQuery innerJoinWithVote() Adds a INNER JOIN clause and with to the query using the Vote relation
 *
 * @method     \App\Model\QuestionQuery|\App\Model\ImageQuery|\App\Model\VoteQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class AnswerQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Model\Base\AnswerQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Model\\Answer', $modelAlias = null)
    {
    ...
    public function filterByImageId($imageId = null, $comparison = null)
    {
        if (is_array($imageId)) {
            ...
            if (isset($imageId['min'])) {
                $this->addUsingAlias(AnswerTableMap::COL_IMAGE_ID, $imageId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($imageId['max'])) {
                $this->addUsingAlias(AnswerTableMap::COL_IMAGE_ID, $imageId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AnswerTableMap::COL_IMAGE_ID, $imageId, $comparison);
    }
    ...
    public function filterByVoteCount($voteCount = null, $comparison = null)
    {
        if (is_array($voteCount)) {
            ...
            if (isset($voteCount['min'])) {
                $this->addUsingAlias(AnswerTableMap::COL_VOTE_COUNT, $voteCount['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($voteCount['max'])) {
                $this->addUsingAlias(AnswerTableMap::COL_VOTE_COUNT, $voteCount['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByWeight($weight = null, $comparison = null)
    {
        if (is_array($weight)) {
            $useMinMax = false;
            if (isset($weight['min'])) {
                $this->addUsingAlias(AnswerTableMap::COL_WEIGHT, $weight['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($weight['max'])) {
                $this->addUsingAlias(AnswerTableMap::COL_WEIGHT, $weight['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AnswerTableMap::COL_WEIGHT, $weight, $comparison);
    }

    /**
     * Filter the query by a related \App\Model\Question object
     *
     * @param \App\Model\Question|ObjectCollection $question The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByImage($image, $comparison = null)
    {
        if ($image instanceof \App\Model\Image) {
            return $this
                ->addUsingAlias(AnswerTableMap::COL_IMAGE_ID, $image->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(AnswerTableMap::COL_IMAGE_ID, $image->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByVote($vote, $comparison = null)
    {
        if ($vote instanceof \App\Model\Vote) {
            return $this
                ->addUsingAlias(AnswerTableMap::COL_ID, $vote->getAnswerId(), $comparison);
