...
abstract class Image implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Model\\Map\\ImageTableMap';
    ...
    /**
     * Initializes internal state of App\Model\Base\Image object.
     */
     ...
     * @return $this|\App\Model\Image The current object (for fluent API support)
     */
    ...
    public function setAuthorId($v)
    {
        ...
        if ($this->author_id !== $v) {
            $this->author_id = $v;
            $this->modifiedColumns[ImageTableMap::COL_AUTHOR_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ImageTableMap::translateFieldName('Filename', TableMap::TYPE_PHPNAME, $indexType)];
            $this->filename = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ImageTableMap::translateFieldName('AuthorId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->author_id = (null !== $col) ? (string) $col : null;
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Model\\Image'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ImageTableMap::COL_AUTHOR_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'filename':
                        ...
                        break;
                    case 'author_id':
                        $stmt->bindValue($identifier, $this->author_id, PDO::PARAM_STR);
                        break;
                    case 'type':
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Model\Image The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ImageTableMap::COL_AUTHOR_ID)) {
            $criteria->add(ImageTableMap::COL_AUTHOR_ID, $this->author_id);
        }
        if ($this->isColumnModified(ImageTableMap::COL_TYPE)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Model\Image (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Model\Image Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aAuthor === null && (($this->author_id !== "" && $this->author_id !== null))) {
            $this->aAuthor = ChildUserQuery::create()->findPk($this->author_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthor->addImages($this);
             */
        }
    ...
    public function initSubjects($overrideExisting = true)
    {
        ...
        $this->collSubjects->setModel('\App\Model\User');
    }
    ...
    public function getSubjects(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collSubjects || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collSubjects) {
                ...
                $collSubjects = ChildUserQuery::create(null, $criteria)
                    ->filterByImage($this)
                    ->find($con);
    ...
    {
        /** @var ChildUser[] $subjectsToDelete */
     ...
     * @return $this|\App\Model\Image The current object (for fluent API support)
     */
    public function addSubject(ChildUser $l)
    {
        if ($this->collSubjects === null) {
            $this->initSubjects();
            $this->collSubjectsPartial = true;
    ...
    /**
     * @param ChildUser $subject The ChildUser object to add.
     */
    protected function doAddSubject(ChildUser $subject)
    {
        $this->collSubjects[]= $subject;
        $subject->setImage($this);
    }

    /**
     * @param  ChildUser $subject The ChildUser object to remove.
     * @return $this|ChildImage The current object (for fluent API support)
     */
    public function removeSubject(ChildUser $subject)
    {
    ...
    public function initAnswers($overrideExisting = true)
    {
        ...
        $this->collAnswers->setModel('\App\Model\Answer');
    }
