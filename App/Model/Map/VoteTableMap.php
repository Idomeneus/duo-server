...
class VoteTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Model.Map.VoteTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Model\\Vote';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Model.Vote';
     ...
     */
    const COL_CREATED = 'vote.created';

    /**
     * the column name for the user_id field
     */
    const COL_USER_ID = 'vote.user_id';

    /**
     * the column name for the answer_id field
     */
    const COL_ANSWER_ID = 'vote.answer_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Created', 'UserId', 'AnswerId', ),
        self::TYPE_CAMELNAME     => array('created', 'userId', 'answerId', ),
        self::TYPE_COLNAME       => array(VoteTableMap::COL_CREATED, VoteTableMap::COL_USER_ID, VoteTableMap::COL_ANSWER_ID, ),
        self::TYPE_FIELDNAME     => array('created', 'user_id', 'answer_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Created' => 0, 'UserId' => 1, 'AnswerId' => 2, ),
        self::TYPE_CAMELNAME     => array('created' => 0, 'userId' => 1, 'answerId' => 2, ),
        self::TYPE_COLNAME       => array(VoteTableMap::COL_CREATED => 0, VoteTableMap::COL_USER_ID => 1, VoteTableMap::COL_ANSWER_ID => 2, ),
        self::TYPE_FIELDNAME     => array('created' => 0, 'user_id' => 1, 'answer_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Model\\Vote');
        $this->setPackage('App.Model');
        $this->setUseIdGenerator(false);
        // columns
        $this->addColumn('created', 'Created', 'TIMESTAMP', true, null, 'now()');
        $this->addForeignKey('user_id', 'UserId', 'CHAR', 'user', 'id', true, null, null);
        $this->addForeignKey('answer_id', 'AnswerId', 'INTEGER', 'answer', 'id', true, null, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Answer', '\\App\\Model\\Answer', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':answer_id',
    1 => ':id',
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(VoteTableMap::COL_CREATED);
            $criteria->addSelectColumn(VoteTableMap::COL_USER_ID);
            $criteria->addSelectColumn(VoteTableMap::COL_ANSWER_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Model\Vote) { // it's a model object
