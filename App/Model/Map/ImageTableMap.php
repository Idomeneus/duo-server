...
class ImageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Model.Map.ImageTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Model\\Image';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Model.Image';
     ...
     */
    const COL_FILENAME = 'image.filename';

    /**
     * the column name for the author_id field
     */
    const COL_AUTHOR_ID = 'image.author_id';
    ...
    const COL_TYPE_PROFILE = 'profile';
    const COL_TYPE_ANSWER = 'answer';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Filename', 'AuthorId', 'Type', ),
        self::TYPE_CAMELNAME     => array('id', 'filename', 'authorId', 'type', ),
        self::TYPE_COLNAME       => array(ImageTableMap::COL_ID, ImageTableMap::COL_FILENAME, ImageTableMap::COL_AUTHOR_ID, ImageTableMap::COL_TYPE, ),
        self::TYPE_FIELDNAME     => array('id', 'filename', 'author_id', 'type', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Filename' => 1, 'AuthorId' => 2, 'Type' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'filename' => 1, 'authorId' => 2, 'type' => 3, ),
        self::TYPE_COLNAME       => array(ImageTableMap::COL_ID => 0, ImageTableMap::COL_FILENAME => 1, ImageTableMap::COL_AUTHOR_ID => 2, ImageTableMap::COL_TYPE => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'filename' => 1, 'author_id' => 2, 'type' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );

    /** The enumerated values for this table */
    protected static $enumValueSets = array(
                ImageTableMap::COL_TYPE => array(
                            self::COL_TYPE_PROFILE,
            self::COL_TYPE_ANSWER,
        ),
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Model\\Image');
        $this->setPackage('App.Model');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('filename', 'Filename', 'CHAR', false, null, null);
        $this->addForeignKey('author_id', 'AuthorId', 'CHAR', 'user', 'id', true, null, null);
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Subject', '\\App\\Model\\User', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':image_id',
    1 => ':id',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ImageTableMap::COL_AUTHOR_ID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Model\Image) { // it's a model object
